...
#define MODEM_COMMAND_TIMEOUT_OPERATOR (300000)  /*!< Timeout value for getting operator status */
...
/**
 * @brief EPS Network status of DCE
 *
 */
typedef enum {
    MT_NOT_REGISTERED,      /*!< not registered, MT is not currently searching an operator to register to */
    MT_REGISTERED,          /*!< registered, home network */
    MT_SEARCHING,           /*!< not registered, but MT is currently trying to attach or searching an operator to register to */
    MT_UNKNOWN,             /*!< registration denied */
    MT_ROAMING,             /*!< registered, roaming */
    MT_REGISTERED_SMS,      /*!< registered for "SMS only", home network (not applicable) */
    MT_ROAMING_SMS          /*!< registered for "SMS only", roaming (not applicable) */
} modem_link_t;
...
struct modem_dce {
    ...
    modem_link_t link;                                                                /*!< Modem network state */
